...
namespace KafkaApp.Models
{
    public partial class TwittorContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            //                optionsBuilder.UseSqlServer("Server=myazure.database.windows.net;Database=Twittor;Trusted_Connection=True;Integrated Security=false;User ID=myazure;Password=Kosongkan@Saja");
            //            }
        }
